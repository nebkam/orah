...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>Rasadnik ORAH &bull; Šljiva</title>
  ...
  <div id="content" class="sorte">
   ...
   <ul class="accent">
    <li class="itemR">
     azmak sadnje
     <ul>
      <li>standardne sorte šljiva</li>
      <li class="hl">5m x 3m</li>
     </ul>
    </li>
   </ul><!--.accent-->
   <p>
    Džanarika je najstarija voćna vrsta Balkanskog poluostrva. Plodove najvišeg 
    kvaliteta daruje bez ikakve hemijske zaštite.
   </p>
  </div><!--#content-->
