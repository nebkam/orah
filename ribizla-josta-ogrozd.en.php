...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>Nursery ORAH &bull; Currant, Gooseberry &amp; Jost</title>
 ...
 <body class="bg4">
  ...
  <ul id="nav">
   ...
   <li id="sorte" class="hasSub">
    ...
    <ul class="sub">
     ...
     <li>
      <a class="current">Currant, Gooseberry &amp; Jost</a>
     </li>
     <li>
  ...
  <div id="content" class="sorte">
   <h1 class="headC">urrant, Gooseberry &amp; Jost</h1>
   <ul class="accent">
    <li class="itemS">
     pace between plants
     <ul>
      <li>Currant</li>
      <li class="hl">2m x 1m</li>
     </ul>
     <ul>
      <li>Jost</li>
