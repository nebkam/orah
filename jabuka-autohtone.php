...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>Rasadnik ORAH &bull; Autohtone sorte jabuka</title>
 ...
 <body class="bg4">
  ...
  <ul id="nav">
   ...
   <li id="sorte" class="hasSub">
    ...
    <ul class="sub">
     ...
     <li>
      <a class="current">Autohtone sorte jabuke</a>
     </li>
     <li>
  ...
  <div id="content" class="sorte">
   <h1 class="headA">utohtone sorte jabuka</h1>
   <h2>Vreme zrenja</h2>
   <table>
    <colgroup>
     <col />
