...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>Nursery ORAH &bull; Plum</title>
  ...
  <div id="content" class="sorte">
   ...
   <ul class="accent">
    <li class="itemS">
     pace between plants
     <ul>
      <li>standard plum varieties</li>
      <li class="hl">5m x 3m</li>
     </ul>
    </li>
   </ul><!--.accent-->
   <p>
    Cherry plum called Dzanarika is the oldest fruit variety of Balkan Peninsula. Highest
    quality fruit is yielded without any chemical protection.
   </p>
  </div><!--#content-->
