...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>Rasadnik ORAH &bull; Jabuka standardna</title>
 ...
 <body class="bg4">
  ...
  <ul id="nav">
   ...
   <li id="sorte" class="hasSub">
    ...
    <ul class="sub">
     <li>
      <a class="current">Standardna jabuka</a>
     </li>
     <li>
  ...
  <div id="content" class="sorte">
   <h1 class="headS">tandardna jabuka</h1>
   <h2>Vreme zrenja</h2>
   ...
   <table>
    ...
    <thead>
     <tr>
      <th>Sorta</th>
      <th colspan="6">Jul</th>
      <th colspan="6">Avgust</th>
      <th colspan="6">Septembar</th>
      <th colspan="6">Oktobar</th>
     </tr>
    </thead>
    <tbody>
     <tr>
     ...
     <tr>
      <th>Zlatni delišes &ldquo;B&rdquo; klon</th>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
   ...
   <ul class="accent dark">
    <li class="itemR">
     azmak sadnje
     <ul>
      <li>Na podlozi M-9:</li>
      <li class="hl">3.8 m x 1.2m</li>
     </ul>
     <ul>
      <li>Na podlozi M-26:</li>
      <li class="hl">4m x 1.5m</li>
     </ul>
     <ul>
      <li>Na podlozi M-27:</li>
      <li class="hl">3m x 0.8m</li>
     </ul>
    </li>
   </ul><!--.accent-->
   
   <p>
    Zahvaljujući oplemenjivačkom radu, savremeno jabučarstvo danas ima sve elemente umetnosti. U 
    novim sortama i klonovima standardnih sorti, kao što su Zlatni delišes, Crveni delišes i Greni 
    Smit, karakteristike ploda i biljke dovedene su do savršenstva, a naša tehnologija zasnivanja i
    eksploatacije voćnjaka omogućava realizaciju punog genetičkog potencijala na prinos i kvalitet 
    ploda.
   </p>
   <p>
    Greni Smit spur ima znatno manju bujnost od standardne sorte, izuzetnu rodnost, a svojim 
    listovima znatno bolje zasenjuje plodove čime ih štiti od pojave bledog rumenila.
   </p>
   <p>
    Novi klonovi u tipu Crvenog delišesa karakterišu se intenzivnom purpurnom bojom ploda koja u
    potpunosti prekriva osnovnu boju, a njena pojava nije uslovljena klimatskim prilikama.
   </p>
