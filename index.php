...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>Rasadnik ORAH &bull; Dobrodošli!</title>
 ...
 <link rel="icon" type="photo/o8CltRtuIQg8Kz0RCfsZDQ?feat=directlink" href="/favicon.ico" />   <link rel="icon" type="image/png" href="/gfx/favicon.png">
 ...
 <body class="bg4">
  ...
  <div id="pesma">
         Gde god nadješ zgodno mesto,
   <br />Tu drvo posadi!
   <br />A drvo je blagodarno
   <br />Pa će da nagradi.
   <br />
   <br />Nagradiće izobiljem
   <br />Hlada, roda svog
   <br />Nagradiće bilo tebe
   <br />Bilo brata tvog.
   <br />
   <br />Čika Jova Zmaj
  </div>
