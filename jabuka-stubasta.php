...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>Rasadnik ORAH &bull; Jabuka stubasta</title>
 ...
 <body class="bg4">
  ...
  <ul id="nav">
   ...
   <li id="sorte" class="hasSub">
    ...
    <ul class="sub">
     ...
     <li>
      <a class="current">Stubasta jabuka</a>
     </li>
     <li>
  ...
  <div id="content" class="sorte">
   <h1 class="headS">tubasta jabuka</h1>
   <h2>Vreme zrenja</h2>
   ...
   <ul class="accent dark">
    <li class="itemR">
     azmak sadnje
     <ul>
      <li class="hl">12 x 0.5m</li>
     </ul>
    </li>
   </ul><!--.accent-->
   
   <p>
    Stubaste jabuke su biološka novina koja omogućava gajenje velikog broja biljaka po jedinici 
    površine (10000 biljaka/ha) i postizanje visokog prinosa na malim površinama. Voćke se gaje 
    bez naslona. Sve radne operacije se obavljaju sa zemlje jer visina voćaka ne prelazi 3m u 
    punoj rodnosti. Ovim katalogom predstavljena su najnovija dostignuća u selekciji stubastih 
    jabuka <span style="white-space:nowrap">prof. dr. Ognjanov Vladislava</span>.
   </p>
   <p>
    Stubaste jabuke zelenog ploda su jedinstvene u Evropi a po kvalitetu i atraktivnosti nadmašuju 
    Greni Smit. Uvek imaju prepoznatljivu zelenu boju i nikada ne dobijaju rumenilo.
   </p>
