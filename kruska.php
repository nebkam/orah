...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>Rasadnik ORAH &bull; Kruška</title>
  ...
  <div id="content" class="sorte">
   ...
   <ul class="accent dark">
    <li class="itemR">
     azmak sadnje
     <ul>
      <li>Sorte kalemljene na dunji:</li>
      <li class="hl">3.8 m x 1.5m</li>
     </ul>
     <ul>
      <li>Sorte kalemljene na sejancu divlje kruške:</li>
   ...
   <p>
    Intenzivna ili savremena proizvodnja kruške podrazumeva daleko veći nivo agro i pomotehničkih 
    mera, a sve u cilju dugoročnog kvantitativnog i kvalitativnog povećanja proizvodnje, što će 
    povećati prihode na poljoprivrednom gazdinstvu.
   </p>
   
   <ul>
    <li class="ulTitle">Principi intenzivne proizvodnje kruške podrazumevaju:</li>
    <li>smanjenje veličine habitusa voćnjaka</li>
    <li>povećanje broja stabala po jedinici površine zasada</li>
    <li>uvodjenje novih sorti</li>
    <li>kontrola formiranja i zamene rodnog drveta</li>
   </ul>
