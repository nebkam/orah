...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>Nursery ORAH &bull; Cherry &amp; Sour Cherry</title>
  ...
  <ul id="nav">
   ...
   <li id="sorte" class="hasSub">
    ...
    <ul class="sub">
     ...
     <li>
      <a class="current">Cherry &amp; Sour Cherry</a>
     </li>
     <li>
