...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>Nursery ORAH &bull; Standard Apple</title>
 ...
 <body class="bg4">
  ...
  <ul id="nav">
   ...
   <li id="sorte" class="hasSub">
    ...
    <ul class="sub">
     <li>
      <a class="current">Standard Apple</a>
     </li>
     <li>
  ...
  <div id="content" class="sorte">
   <h1 class="headS">tandard Apple</h1>
   ...
   <table>
    ...
    <tbody>
     ...
     <tr>
      <th>Golden Delicious &ldquo;B&rdquo; clone</th>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
   ...
   <ul class="accent dark">
    <li class="itemS">
     pace between plants
     <ul>
      <li>On the M-9 base:</li>
      <li class="hl">3.8 m x 1.2m</li>
     </ul>
     <ul>
      <li>On the M-26 base:</li>
      <li class="hl">4m x 1.5m</li>
     </ul>
     <ul>
      <li>On the M-27 base:</li>
   ...
   <p>
    Thanks to cultivation and grafting, apple-growing nowdays has all the elements of art.
    Characteristics of fruit and plant found in new cultivars of standard varieties, such as
    Golden and Red Delicious and Granny Smith, are brought to perfection. Our technology of
    planting and orchard exploatation enables realization of full genetic potential for yield
    and quality of fruit. 
   </p>
   <p>
    Granny Smith Spur is less luxuriant than the standard variety, has extraordinary yield
    and fruit is well-protected by leaves and therefore protect from &quot;discoloured 
    blush&quot;.
   </p>
   <p>
    New cultivars of Red Delicious are always intensive bright red colour which completely
    covers the base colour and it happens regardless of climate conditions. 
   </p>
