...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  <title>Nursery ORAH &bull; Walnut, Hazelnut &amp; Almond</title>
 ...
 <body class="bg4">
  ...
  <ul id="nav">
   ...
   <li id="sorte" class="hasSub">
    ...
    <ul class="sub">
     ...
     <li>
      <a class="current">Walnut, Hazelnut &amp; Almond</a>
     </li>
     <li>
  ...
  <div id="content" class="sorte">
   ...
   <h1 class="headW">alnut</h1>
   <p>
    is often planted in paired orchards with apricot, plum and peach.
   </p>
   <table class="randman">
    <colgroup>
     <col />
  ...
  <ul class="accent">
    <li class="itemS">
     ...
     <ul>
      <li>in the triangle</li>
      <li class="hl">12m x 9.36m</li>
     </ul>
    </li>
   </ul><!--.accent-->
   <p>
    The fruits of these varieties are large, over 14 g, with a thin skin and high-quality core.
    They are very fertile varieties, and some are beginning to bear already in the nursery.
    All have a high degree of tolerance to the agents of disease. They ripe in September.
   </p>
  
   <h1 class="headH">azelnut</h1>
   ...
   <p>
    Best varieties have large fruit, are oval in shape, and in inflorescence develop two to four
    fruits. They easily fall out from the envelope. The core is spherical, solid and high in
    quality.
   </p>
   
   <h1 class="headA">lmond</h1>
   <h2>Time of Riping</h2>
